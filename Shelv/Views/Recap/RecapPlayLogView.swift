...
struct RecapPlayLogView: View {
    ...
    var body: some View {
        List {
            Section {
                HStack {
                    Text(tr("recap.recap.play.log.total_plays"))
                    Spacer()
                    Text("\(logCount)")
            ...
            Section(tr("recap.recap.play.log.recent_plays")) {
                if logs.isEmpty {
                    Text(tr("recap.recap.play.log.no_plays_recorded_yet"))
                        .foregroundStyle(.secondary)
                        .font(.subheadline)
                } else {
        ...
        .navigationTitle(tr("recap.recap.play.log.recent_plays"))
