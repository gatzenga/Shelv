...
private struct TVPlayerPalettePixelSample {
    let red: CGFloat
    let green: CGFloat
    let blue: CGFloat
...
private extension UIImage {
    func extractTVPlayerPalette() -> (UIColor, UIColor?) {
        ...
        var chromaticSamples = [[TVPlayerPalettePixelSample]](repeating: [], count: 12)
        ...
        for index in stride(from: 0, to: pixels.count, by: 4) {
            ...
            if bucket < 12 {
                chromaticSamples[bucket].append(TVPlayerPalettePixelSample(
                    red: r,
                    green: g,
                    blue: b,
                    brightness: v
        ...
        func averageColor(of samples: ArraySlice<TVPlayerPalettePixelSample>) -> UIColor {
