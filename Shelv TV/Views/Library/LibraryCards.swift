...
extension View {
    ...
    /// `fade` = Anteil der Höhe je Kante (Default 0.10). Kleiner = klarerer Rand, der
    /// erste Inhalt sitzt höher und verschwindet nicht so leicht in der Ausblendung.
    func edgeFadeMask(fade: CGFloat = 0.10) -> some View {
        mask(LinearGradient(
            stops: [
